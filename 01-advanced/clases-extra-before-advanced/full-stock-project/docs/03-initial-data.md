# Datos iniciales para el servidor

Para comenzar el desarrollo, nuestro servidor trabajará con un objeto JavaScript en memoria que simula una base de datos. Este objeto contiene las categorías, productos, carritos y órdenes disponibles en la tienda. Puedes copiar y pegar el siguiente objeto en tu archivo JS para usarlo directamente:
  ...
  categories: [
    {
      ...
      description: "Polos exclusivos con diseños que todo desarrollador querrá lucir. Ideales para llevar el código a donde vayas."
    },
    {
      id: 2,
      title: "Tazas",
      ...
      description: "Tazas que combinan perfectamente con tu café matutino y tu pasión por la programación."
    },
    {
      id: 3,
      title: "Stickers",
      ...
      description: "Personaliza tu espacio de trabajo con nuestros stickers únicos y muestra tu amor por el desarrollo web."
    }
  ],
  products: [
    {
